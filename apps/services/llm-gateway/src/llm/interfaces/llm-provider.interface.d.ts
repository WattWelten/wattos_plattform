...
export interface LlmProvider {
    ...
    createChatCompletion(request: ChatCompletionRequestDto, options?: ProviderCallOptions): Promise<ChatCompletionResponse>;
    createCompletion?(request: CompletionRequestDto, options?: ProviderCallOptions): Promise<ChatCompletionResponse>;
    streamChatCompletion?(request: ChatCompletionRequestDto, options?: ProviderCallOptions): AsyncGenerator<ChatCompletionChunk, void, unknown>;
