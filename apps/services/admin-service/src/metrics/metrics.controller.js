...
let MetricsController = class MetricsController {
    ...
    async getLLMUsageMetrics(tenantId, startDate, endDate) {
        return this.metricsService.getLLMUsageMetrics(tenantId, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MetricsController.prototype, "getLLMUsageMetrics", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MetricsController.prototype, "getAgentPerformanceMetrics", null);
