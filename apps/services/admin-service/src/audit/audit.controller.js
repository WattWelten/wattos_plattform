...
let AuditController = class AuditController {
    ...
    async getAuditStats(tenantId, startDate, endDate) {
        return this.auditService.getAuditStats(tenantId, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [audit_dto_1.AuditLogQueryDto]),
